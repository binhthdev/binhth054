...
Route::post('/search','App\Http\Controllers\CategoryProduct@Search')->name('routeSearch');
...
Route::post('/search','App\Http\Controllers\BrandProduct@Search')->name('routeSearch');
...
Route::post('/search','App\Http\Controllers\ProductController@Search')->name('routeSearch');
...
//Cart
Route::post('/save-cart/{product_id}','App\Http\Controllers\CartController@save_cart');
...
//Checkout
Route::get('login-checkout','App\Http\Controllers\CheckoutController@login_checkout')->name('login_checkout');
...
Route::post('register', 'App\Http\Controllers\SignUpController@store')->name('register');
Route::post('login', 'App\Http\Controllers\SignInController@checkLogin')->name('checklogin');
Route::get('logoutUser', 'App\Http\Controllers\SignInController@logout')->name('logoutUser');